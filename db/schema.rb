...
ActiveRecord::Schema.define(version: 20170611011451) do
  ...
  create_table "oauth_users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["email"], name: "index_oauth_users_on_email", unique: true, using: :btree
    t.index ["reset_password_token"], name: "index_oauth_users_on_reset_password_token", unique: true, using: :btree
  end
